		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
					<h2 class="cursive-font">购物车</h2>
					<p>请确认您想点的菜品以及数量，使用确认进行下一步，或者使用清空购物车清除购物车里的内容</p>
				</div>
			</div>
			<div class="row">
				<h4 style="color:white">购物车列表信息</h4>
				<table width="100%" border="2">
					<tr>
						<td style="color:white">商品编号</td>
						<td style="color:white">商品名称</td>
						<td style="color:white">商品单价</td>
						<td style="color:white">商品数量</td>
						<td style="color:white">商品总额</td>
					...
					<c:forEach var="item" items="${cart.map }">
						<tr>
							...
							<!-- Items -->
							<td style="color:white">${item.value.product.name }</td>
							<td style="color:white">${item.value.product.price }</td>
							<td>
							...
							<td style="color:white">${item.value.product.price*item.value.num }</td>
							<td>
								<input type="button" name="id" value="删除" onclick="javascript:deleteProductItem(${item.key})"/>
							</td>
						</tr>
					</c:forEach>
				</table>
				...
				<div style="float: right;">
					<a  href ="contact.jsp" style="color:#fbb448" class="btn btn-default">确认订单</a>
					<a  href ="ProServlet?type=clear" style="color:#fbb448" class="btn btn-default">清空购物车</a>
					<a  href ="ProServlet" style="color:#fbb448" class="btn btn-default">返回上一级</a>
				</div>
		...
		<div class="gtco-container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					...
					<p>Be the first to know about the new MENU!.</p>
				</div>
			</div>
			<div class="row animate-box">
