...
<html lang="en">
                            ...
                            <table class="table">
                             ...
                             <%!int i=1; %>
                                ...
                                <td><% out.print(i++);  %></td>
                                  ...
                                  <td>
                                  <div class="btn-group">
                                      <input type="button" class="btn btn-danger" name="id" value="删除" onclick="javascript:deleteOrderItem(${row.orderid})"/>
                                  </div>
                                  </td>
                                </tr>
                             </c:forEach>
  ...
  <!-- container section end -->
    ...
    function deleteOrderItem(id){
        ...
        if(confirm("确定删除该订单吗？")){
            createXhr();
            xhr.open("get", "DelorderServlet?type=delete&id="+id, true);
            xhr.send();
