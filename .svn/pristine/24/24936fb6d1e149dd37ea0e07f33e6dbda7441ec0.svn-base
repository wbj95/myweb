...
public class DbDao {
    ...
    public boolean deletePro(String sql,String product_name) throws Exception{
    	PreparedStatement pstmt = (PreparedStatement)getConnection().prepareStatement(sql);
    	int i=1;
    	pstmt.setString(i, product_name);
    	if(pstmt.executeUpdate() != 1)
            return false;
    	return true;
    }
    public boolean deleteOrder(String sql,int orderid) throws Exception{
    	PreparedStatement pstmt = (PreparedStatement)getConnection().prepareStatement(sql);
    	int i=1;
