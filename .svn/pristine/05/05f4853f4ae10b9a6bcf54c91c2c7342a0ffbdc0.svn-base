		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_document_alt"></i>表单</li>
						<li><i class="fa fa-files-o"></i>删除商品</li>
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
			...
			<br/>
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="get" action="DeleteServlet">
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">商品名 <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="delete_pro" name="delete_pro"  type="text" required />
                                          </div>
                                      </div>
